...
# converts 3 letter country code to 2
code_hash = {"AFG"=>"AF", "ALB"=>"AL", "DZA"=>"DZ", "ASM"=>"AS", "AND"=>"AD", "AGO"=>"AO", "AIA"=>"AI", "ATA"=>"AQ", "ATG"=>"AG", "ARG"=>"AR", "ARM"=>"AM", "ABW"=>"AW", "AUS"=>"AU", "AUT"=>"AT", "AZE"=>"AZ", "BHS"=>"BS", "BHR"=>"BH", "BGD"=>"BD", "BRB"=>"BB", "BLR"=>"BY", "BEL"=>"BE", "BLZ"=>"BZ", "BEN"=>"BJ", "BMU"=>"BM", "BTN"=>"BT", "BOL"=>"BO", "BQ"=>" Sint Eustatius and Saba", "BIH"=>"BA", "BWA"=>"BW", "BVT"=>"BV", "BRA"=>"BR", "IOT"=>"IO", "BRN"=>"BN", "BGR"=>"BG", "BFA"=>"BF", "BDI"=>"BI", "CPV"=>"CV", "KHM"=>"KH", "CMR"=>"CM", "CAN"=>"CA", "CYM"=>"KY", "CAF"=>"CF", "TCD"=>"TD", "CHL"=>"CL", "CHN"=>"CN", "CXR"=>"CX", "CCK"=>"CC", "COL"=>"CO", "COM"=>"KM", "COD"=>"CD", "COG"=>"CG", "COK"=>"CK", "CRI"=>"CR", "HRV"=>"HR", "CUB"=>"CU", "CUW"=>"CW", "CYP"=>"CY", "CZE"=>"CZ", "CIV"=>"CI", "DNK"=>"DK", "DJI"=>"DJ", "DMA"=>"DM", "DOM"=>"DO", "ECU"=>"EC", "EGY"=>"EG", "SLV"=>"SV", "GNQ"=>"GQ", "ERI"=>"ER", "EST"=>"EE", "SWZ"=>"SZ", "ETH"=>"ET", "FLK"=>"FK", "FRO"=>"FO", "FJI"=>"FJ", "FIN"=>"FI", "FRA"=>"FR", "GUF"=>"GF", "PYF"=>"PF", "ATF"=>"TF", "GAB"=>"GA", "GMB"=>"GM", "GEO"=>"GE", "DEU"=>"DE", "GHA"=>"GH", "GIB"=>"GI", "GRC"=>"GR", "GRL"=>"GL", "GRD"=>"GD", "GLP"=>"GP", "GUM"=>"GU", "GTM"=>"GT", "GGY"=>"GG", "GIN"=>"GN", "GNB"=>"GW", "GUY"=>"GY", "HTI"=>"HT", "HMD"=>"HM", "VAT"=>"VA", "HND"=>"HN", "HKG"=>"HK", "HUN"=>"HU", "ISL"=>"IS", "IND"=>"IN", "IDN"=>"ID", "IRN"=>"IR", "IRQ"=>"IQ", "IRL"=>"IE", "IMN"=>"IM", "ISR"=>"IL", "ITA"=>"IT", "JAM"=>"JM", "JPN"=>"JP", "JEY"=>"JE", "JOR"=>"JO", "KAZ"=>"KZ", "KEN"=>"KE", "KIR"=>"KI", "PRK"=>"KP", "KOR"=>"KR", "KWT"=>"KW", "KGZ"=>"KG", "LAO"=>"LA", "LVA"=>"LV", "LBN"=>"LB", "LSO"=>"LS", "LBR"=>"LR", "LBY"=>"LY", "LIE"=>"LI", "LTU"=>"LT", "LUX"=>"LU", "MAC"=>"MO", "MDG"=>"MG", "MWI"=>"MW", "MYS"=>"MY", "MDV"=>"MV", "MLI"=>"ML", "MLT"=>"MT", "MHL"=>"MH", "MTQ"=>"MQ", "MRT"=>"MR", "MUS"=>"MU", "MYT"=>"YT", "MEX"=>"MX", "FSM"=>"FM", "MDA"=>"MD", "MCO"=>"MC", "MNG"=>"MN", "MNE"=>"ME", "MSR"=>"MS", "MAR"=>"MA", "MOZ"=>"MZ", "MMR"=>"MM", "NAM"=>"NA", "NRU"=>"NR", "NPL"=>"NP", "NLD"=>"NL", "NCL"=>"NC", "NZL"=>"NZ", "NIC"=>"NI", "NER"=>"NE", "NGA"=>"NG", "NIU"=>"NU", "NFK"=>"NF", "MNP"=>"MP", "NOR"=>"NO", "OMN"=>"OM", "PAK"=>"PK", "PLW"=>"PW", "PS"=>" State of", "PAN"=>"PA", "PNG"=>"PG", "PRY"=>"PY", "PER"=>"PE", "PHL"=>"PH", "PCN"=>"PN", "POL"=>"PL", "PRT"=>"PT", "PRI"=>"PR", "QAT"=>"QA", "MKD"=>"MK", "ROU"=>"RO", "RUS"=>"RU", "RWA"=>"RW", "REU"=>"RE", "BLM"=>"BL", "SH"=>" Ascension and Tristan da Cunha", "KNA"=>"KN", "LCA"=>"LC", "MAF"=>"MF", "SPM"=>"PM", "VCT"=>"VC", "WSM"=>"WS", "SMR"=>"SM", "STP"=>"ST", "SAU"=>"SA", "SEN"=>"SN", "SRB"=>"RS", "SYC"=>"SC", "SLE"=>"SL", "SGP"=>"SG", "SXM"=>"SX", "SVK"=>"SK", "SVN"=>"SI", "SLB"=>"SB", "SOM"=>"SO", "ZAF"=>"ZA", "SGS"=>"GS", "SSD"=>"SS", "ESP"=>"ES", "LKA"=>"LK", "SDN"=>"SD", "SUR"=>"SR", "SJM"=>"SJ", "SWE"=>"SE", "CHE"=>"CH", "SYR"=>"SY", "TWN"=>"TW", "TJK"=>"TJ", "TZ"=>" United Republic of", "THA"=>"TH", "TLS"=>"TL", "TGO"=>"TG", "TKL"=>"TK", "TON"=>"TO", "TTO"=>"TT", "TUN"=>"TN", "TUR"=>"TR", "TKM"=>"TM", "TCA"=>"TC", "TUV"=>"TV", "UGA"=>"UG", "UKR"=>"UA", "ARE"=>"AE", "GBR"=>"GB", "UMI"=>"UM", "USA"=>"US", "URY"=>"UY", "UZB"=>"UZ", "VUT"=>"VU", "VEN"=>"VE", "VNM"=>"VN", "VGB"=>"VG", "VIR"=>"VI", "WLF"=>"WF", "ESH"=>"EH", "YEM"=>"YE", "ZMB"=>"ZM", "ZWE"=>"ZW", "ALA"=>"AX"}

uniq_country_hash = {}

# scroll to the bottom of the file to see the logic
...
[
  ...
  three_letter_country_code = country.split(",")[1]

  two_letter_code = code_hash[three_letter_country_code]

  # create a hash where the key is the two letter code, and the value is
  # the country string that includes the gdp
  uniq_country_hash[two_letter_code] = country
end

# open the json file called country_data.json, and parse the json into a ruby hash
country_geojson_data = JSON.parse(File.read('./src/country_data.json'))

misses = []

# replace the features property with the features+gdp
country_geojson_data["features"] = country_geojson_data["features"].map do |feature|
  # grab the three letter country code
  country_code = feature["properties"]["ISO"]
  # grab the name so we can see the misses
  name = feature["properties"]["COUNTRY"]

  # this is the string that includes the gdp
  country_gdp_string = uniq_country_hash[country_code]

  # couldnt match the country code. this happens for
  # mostly small stupid islands
  if country_gdp_string.nil?
    misses << name
    # return the original feature
    feature
  else
    # grab the gdp from the string. then merge a gdp attr
    # into the feature's properties
    gdp = country_gdp_string.split(",")[3]

    properties_with_gdp = feature["properties"].merge({"gdp" => gdp})
    feature.merge({"properties" => properties_with_gdp})
  end
end

# p 'country_geojson_data!!'
# p country_geojson_data
...
# write country_geojson_data to a file called country_data2.json
File.open('./src/country_data2.json', 'w') do |f|
  f.write(country_geojson_data.to_json)
end
